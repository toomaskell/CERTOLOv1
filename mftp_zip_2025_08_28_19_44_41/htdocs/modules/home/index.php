        ...
        <div class="row g-2 align-items-center">
            <div class="col-lg-6 py-6">
                <h1 class="text-white display-4 fw-bold mb-4">
                    Streamline Your Certification Process with CERTDESK
                </h1>
...
<div class="page-body" id="features">
    <div class="container-xl">
        <div class="row justify-content-center text-center mb-6">
            <div class="col-lg-8">
                <h2 class="display-5 mb-3">Why Choose CERTDESK?</h2>
                <p class="lead text-muted">
                    Built specifically for certification bodies and companies seeking certification, 
                    CERTDESK makes the entire process efficient, transparent, and secure.
                </p>
            </div>
        </div>
...
<div class="container-xl py-6" id="how-it-works">
    <div class="row justify-content-center text-center mb-6">
        <div class="col-lg-8">
            <h2 class="display-5 mb-3">How CERTDESK Works</h2>
            <p class="lead text-muted">
...
<div class="container-xl py-6 text-center" id="contact">
    ...
    <p class="lead text-muted mb-4">
        Join CERTDESK today and streamline your certification process
    </p>
