...
<head>
    ...
    <title><?php echo isset($pageTitle) ? Security::escape($pageTitle) . ' - ' : ''; ?>CERTDESK - Certification Management System</title>
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href="/" class="navbar-brand-logo">
                        ...
                        if (file_exists($_SERVER['DOCUMENT_ROOT'] . $logoPath)): ?>
                            <img src="<?php echo $logoPath; ?>" alt="CERTDESK" class="navbar-brand-image">
