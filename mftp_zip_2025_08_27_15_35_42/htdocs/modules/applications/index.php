...
function listApplications() {
    ...
    <!-- Custom Badge Styles for CERTOLO -->
    <style>
        /* CERTOLO Application Status Badges */
        .badge-draft {
        ...
        .badge-approved {
            background-color: <?php echo COLOR_PRIMARY_LIGHT; ?> !important;
            color: #ffffff !important;
            border: 1px solid <?php echo COLOR_PRIMARY_LIGHT; ?>;
        }
        ...
        .badge-issued {
            ...
            color: #ffffff !important;
            border: 1px solid <?php echo COLOR_PRIMARY_DARK; ?>;
        }
        
        /* Status Cards Custom Colors */
        .status-card-draft .avatar {
            background-color: #6c757d !important;
        }
        
        .status-card-submitted .avatar {
            background-color: #0ea5e9 !important;
        }
        
        .status-card-under-review .avatar {
            background-color: <?php echo COLOR_ACCENT; ?> !important;
        }
        
        .status-card-approved .avatar {
            background-color: <?php echo COLOR_PRIMARY_LIGHT; ?> !important;
        }
        
        .status-card-rejected .avatar {
            background-color: #dc3545 !important;
        }
        
        .status-card-issued .avatar {
            background-color: <?php echo COLOR_PRIMARY_DARK; ?> !important;
        }
    </style>
        ...
        <div class="container-xl">
            ...
            <div class="row row-cards mb-3">
                <div class="col-sm-6 col-lg-2">
                    <div class="card card-sm status-card-draft">
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-lg-2">
                    <div class="card card-sm status-card-submitted">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <span class="text-white avatar">
                ...
                <div class="col-sm-6 col-lg-2">
                    <div class="card card-sm status-card-under-review">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <span class="text-white avatar">
                ...
                <div class="col-sm-6 col-lg-2">
                    <div class="card card-sm status-card-approved">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <span class="text-white avatar">
                ...
                <div class="col-sm-6 col-lg-2">
                    <div class="card card-sm status-card-rejected">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <span class="text-white avatar">
                ...
                <div class="col-sm-6 col-lg-2">
                    <div class="card card-sm status-card-issued">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <span class="text-white avatar">
                            ...
                            <?php else: ?>
                                <?php foreach ($applications as $app): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            // Custom badge classes for CERTOLO styling
                                            $statusBadges = [
                                                'draft' => 'badge-draft',
                                            ...
                                            $badgeClass = $statusBadges[$app['status']] ?? 'badge-draft';
                                            ...
                                            $displayText = $statusText[$app['status']] ?? ucwords(str_replace('_', ' ', $app['status']));
                                            ?>
